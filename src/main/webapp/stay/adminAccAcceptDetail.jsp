    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="${acc.price_per_night != accUpdate.price_per_night ? 'highlight' : ''}">
            	<fmt:formatNumber value="${accUpdate.price_per_night}" pattern="#,###"/>원</td>
        </tr>
        <tr>
            <td>설명</td>
        ...
        <tr>
            ...
            <td class="${(not empty updateRoom and updateRoom.price_per_night != room.price_per_night) ? 'highlight' : ''}">
                <c:choose>
                    ...
                    <c:otherwise><fmt:formatNumber value="${room.price_per_night}" pattern="#,###"/>원</c:otherwise>
                </c:choose>
            </td>
        </tr>
        <tr>
            ...
            <td class="${(not empty updateRoom and updateRoom.capacity != room.capacity) ? 'highlight' : ''}">
            	<c:out value="${updateRoom.capacity}" default="-" /> 명</td>
        </tr>
        <tr>
            <td>방 이미지</td>
